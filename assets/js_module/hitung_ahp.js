        ...
        swalConfirm.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    enctype: 'multipart/form-data',
                    url: base_url+'hitung_ahp/next_step_proyek',
                    data: data,
                    dataType: "JSON",
                    processData: false,
                    contentType: false, 
                    ...
                    success: function (response) {
                        if(response.status){
                            swalConfirm.fire(
                                ...
                                window.location.href = base_url+"hitung_ahp/formulir_hitung/"+response.id_hitung+'?kategori='+response.id_kategori;
                            });
                        }else{
...
function delete_data(id){
    swalConfirmDelete.fire({
        ...
        if (result.value) {
            $.ajax({
                url : base_url + 'hitung_ahp/delete_data',
                type: "POST",
                dataType: "JSON",
                data : {id:id},
                success: function(data)
